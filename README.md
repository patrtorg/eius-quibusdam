# @patrtorg/eius-quibusdam

![CI](https://github.com/patrtorg/eius-quibusdam/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@patrtorg/eius-quibusdam.svg?style=flat)](https://www.npmjs.com/package/@patrtorg/eius-quibusdam)
[![js-standard-style](https://img.shields.io/badge/code%20style-standard-brightgreen.svg?style=flat)](https://standardjs.com/)


`@patrtorg/eius-quibusdam` enables the use of [CORS](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing) in a Fastify application.

## Install
```
npm i @patrtorg/eius-quibusdam
```
...
## Usage
Require `@patrtorg/eius-quibusdam` and register it as any other plugin, it will add an `onRequest` hook and a [wildcard options route](https://github.com/fastify/fastify/issues/326#issuecomment-411360862).
```js
import Fastify from 'fastify'
import cors from '@patrtorg/eius-quibusdam'
...
fastify.register(require('@patrtorg/eius-quibusdam'), (instance) => {
  return (req, callback) => {
    const corsOptions = {
...
By default, `@patrtorg/eius-quibusdam` adds a `onRequest` hook where the validation and header injection are executed. This can be customized by passing `hook` in the options. Valid values are `onRequest`, `preParsing`, `preValidation`, `preHandler`, `preSerialization`, and `onSend`.
...
fastify.register(require('@patrtorg/eius-quibusdam'), {
  hook: 'preHandler',
